...
function DemoChat({ client, isOpen, onToggle }) {
  const greeting = `Hi there! Welcome to ${client.name}. I can help you with pricing, scheduling, or any questions about our services. What's your name and best phone number so we can follow up if needed?`;
      ...
      const res = await fetch("/api/chat", {
        ...
        body: JSON.stringify({
          ...
          businessInfo: {
            ...
            prompt: `You are Jordan, the AI chat assistant for ${client.name}. ${client.tagline}. Phone: ${client.phone}. Hours: ${client.hours}.
...
9. When a customer wants to book an appointment and you have their name and phone number, give them this link: https://cal.com/tedz-integrative-systems/service-appointment and tell them to pick a time.`,
    ...
    return (
      <button
        ...
        style={{
          ...
          cursor: "pointer",
          boxShadow: `0 6px 24px ${client.color}55`,
          display: "flex",
          alignItems: "center",
  ...
  return (
    ...
    >
      ...
      >
        {messages.map((m, i) => (
          ...
          >
            ...
            >
              {m.role === "assistant"
                ? renderMessageContent(m.content, client.color)
                : m.content}
            </div>
          </div>
        ))}
      ...
      >
        <a
          href="https://tedzintegrativesystems.com"
          target="_blank"
          rel="noopener noreferrer"
          style={{
            color: "#94A3B8",
        ...
        >
          Powered by{" "}
          <span style={{ color: "#ff5c1a", fontWeight: 700 }}>TEDZ</span>
        </a>
      </div>
  ...
  if (!client) {
    return (
      ...
      >
        ...
        <p
          style={{ color: "#94A3B8", fontSize: 16, marginBottom: 24 }}
        >
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span>
            <strong style={{ color: "#ff5c1a" }}>TEDZ Demo</strong> — AI
            chat preview for{" "}
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            ...
            <div style={{ color: client.colorLight, fontSize: 12 }}>
              {client.tagline}
            </div>
          </div>
        </div>
      ...
      {/* Services */}
      <section
        style={{ padding: "48px 32px", maxWidth: 900, margin: "0 auto" }}
      >
        <h2
          style={{
            textAlign: "center",
      ...
      <section style={{ padding: "48px 32px", textAlign: "center" }}>
        ...
        >
          ...
          >
            Click the chat bubble in the bottom right. Ask about pricing,
            hours, services — it already knows everything about{" "}
            {client.name}.
          </p>
          <button
            onClick={() => setChatOpen(true)}
